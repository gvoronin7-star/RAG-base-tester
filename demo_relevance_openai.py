...
Использует OpenAI API вместо PyTorch (более стабильное решение).
...
def main():
    """
    Демонстрация использования RelevanceScorerOpenAI с тестовыми данными из задания.
    """
    print("=" * 70)
    ...
    print("\n[STEP 1] Инициализация модели эмбеддингов OpenAI...")
